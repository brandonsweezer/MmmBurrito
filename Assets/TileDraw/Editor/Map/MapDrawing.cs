...
public class MapDrawing : EditorWindow
{
    ...
    private void OnSceneGUI(SceneView sceneView)
    {
		...
		case EventType.MouseDown:
				// start section added by Nicolas Kuhn de Chizelle
				bool notModified = !e.control && !e.alt && !e.shift;
				// end section added by Nicolas Kuhn de Chizelle
				if (Event.current.button == 0 && notModified)
                {
